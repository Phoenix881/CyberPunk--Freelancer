...
mixer.music.load("Project/Game/Music/backgroundMusic.mp3")
mixer.music.play(-1)

# Adding player
playerSprite = [] # List of locations of choisen character's files

settingsFile = open("Project/Game/settings.txt"); settings = []
...
# Best score
bestScoreFile = open("Project/Game/Code/score.txt", "r"); bestScoreFileLines = []
...
def noDebt(x, y):
    ...
    if playedSuccesSound == False:
        payed = mixer.Sound("Project/Game/Music/debtPayed.wav")
        payed.play()
...
def game_over_text():
    ...
    if playedGameOverSound == False:
        gameOverSound = mixer.Sound("Project/Game/Music/gameOver.mp3")
        gameOverSound.play()
...
while running:
    ...
    if lifes == 3 and score > 10:
        ...
        if score > int(BS_score):
            remove("Project/Game/Code/score.txt")
            newBestScore = score
            newBestScoreFile = open("Project/Game/Code/score.txt", "x")
